...
// Fetch featured stories from the database for the "For Readers" section
$storyQuery = "SELECT id, title, content FROM stories LIMIT 3"; // Get 3 stories for the preview
...
if ($storyResult->num_rows > 0) {
    ...
    $stories = []; // Fallback if no stories found
}
?>
        ...
        <div class="row">
                        ...
                        <ul class="list-group">
                            <?php foreach ($stories as $story): ?>
                                <li class="list-group-item">
                                    <a href="read_story.php?story_id=<?= $story['id'] ?>"><?= htmlspecialchars($story['title']) ?></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    <?php else: ?>
            ...
            <div class="col-md-6 mb-4">
                <div class="feature-box">
                    ...
                    <a href="write_story.php" class="btn btn-primary">Start Writing</a>
                </div>
            </div>
